...
Once that is done you should be ready to run any of the npm scripts.
...
Concurrently runs the above start script and a script to watch for style changes and run postcss as needed. This is borrowed from Wes Bos's React course. There may be a better way to do this, but I'm sticking with it for now, probably until I eject the app.
